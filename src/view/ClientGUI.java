...
/**
 * @authors Team Dungeon Masters CSC 335 Project Manager: Dylan
 * 
 */
...
public class ClientGUI extends JFrame {
	...
	private void registerListeners() {
		...
		/**
		 * Calls onExit() when JFrame is closed Source:
	...
	private void layoutGUI() {
		...
		// Main panel containing both game and chat panels (left to right
		// layout)
	...
	public void askForServer() {
		...
		int result = JOptionPane.showConfirmDialog(null, serverPanel,
				"Server information", JOptionPane.OK_CANCEL_OPTION);
